...
[//]: # (As I was generating a module, generating it with an ID resulted into an error:)
[//]: # (Error: Unexpected argument: 1000)
[//]: # (See more help with --help)
[//]: # (But once i removed the ID, everything worked as expected)
...
----
Creating module skeleton with module name "hello"
